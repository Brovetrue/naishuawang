...
import com.chiu.naishuawangnextbackend.constant.CommonConstant;
import com.chiu.naishuawangnextbackend.exception.ErrorCode;
import com.chiu.naishuawangnextbackend.exception.ThrowUtils;
import com.chiu.naishuawangnextbackend.mapper.QuestionBankMapper;
...
import com.chiu.naishuawangnextbackend.utils.SqlUtils;
...
public class QuestionBankServiceImpl extends ServiceImpl<QuestionBankMapper, QuestionBank> implements QuestionBankService {
    ...
    public QueryWrapper<QuestionBank> getQueryWrapper(QuestionBankQueryRequest questionBankQueryRequest) {
        ...
        //模糊查询
        queryWrapper.like(StringUtils.isNoneBlank(title),"title", title);
        queryWrapper.like(StringUtils.isNoneBlank(description),"description", description);
        // 精确查询
        queryWrapper.ne(ObjectUtils.isNotEmpty(notId), "id", notId);
        queryWrapper.eq(ObjectUtils.isNotEmpty(id), "id", id);
        queryWrapper.eq(ObjectUtils.isNotEmpty(userId), "userId", userId);
        queryWrapper.like(StringUtils.isNoneBlank(picture),"picture", picture);
        // 排序规则
