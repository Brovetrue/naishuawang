...
import com.chiu.naishuawangnextbackend.model.dto.question.QuestionQueryRequest;
import com.chiu.naishuawangnextbackend.model.dto.questionBank.QuestionBankAddRequest;
import com.chiu.naishuawangnextbackend.model.dto.questionBank.QuestionBankEditRequest;
import com.chiu.naishuawangnextbackend.model.dto.questionBank.QuestionBankQueryRequest;
import com.chiu.naishuawangnextbackend.model.dto.questionBank.QuestionBankUpdateRequest;
import com.chiu.naishuawangnextbackend.model.entity.Question;
import com.chiu.naishuawangnextbackend.model.entity.QuestionBank;
import com.chiu.naishuawangnextbackend.model.entity.User;
import com.chiu.naishuawangnextbackend.model.vo.QuestionBankVO;
import com.chiu.naishuawangnextbackend.model.vo.QuestionVO;
import com.chiu.naishuawangnextbackend.service.QuestionBankService;
...
public class QuestionBankController {
     ...
     */
    @PostMapping("/add")
    @SaCheckRole(UserConstant.ADMIN_ROLE) // 只有管理员才能创建题库
     ...
     */
    @PostMapping("/delete")
    @SaCheckRole(UserConstant.ADMIN_ROLE) // 只有管理员才能删除题库
     ...
     */
    @PostMapping("/update")
    @SaCheckRole(UserConstant.ADMIN_ROLE) // 只有管理员才能更新题库
     ...
     */
    @PostMapping("/edit")
    @SaCheckRole(UserConstant.ADMIN_ROLE) // 仅管理员可编辑
